...
class PPOTrainer(BaseTrainer):
    ...
    def predict(self,batch,models,isTrain,step,epoch):
        ...
        cards_hand_embed=models["CardsHandEmbed"](
            batch["card_hand_card_ids"],
            batch["card_hand_card_types"],
            batch["card_hand_card_costs"],
            batch["card_hand_card_special_types"],
            batch["card_hand_card_atks"],
            batch["card_hand_card_hps"],
            batch["card_hand_card_has_attack"],
            batch["card_hand_card_has_defend"],
            batch["card_hand_card_mask"]
        )
