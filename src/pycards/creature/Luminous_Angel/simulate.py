...
class Luminous_Angel_Simulation(Card_Simulation):
    ...
    similar_descriptions:list[str]=[
        ...
        "Flying, Lifelink. At the start of your upkeep, if you have 20 or more life, [CARD_NAME] gets +1/+1.",

        "Flying, Lifelink. During your upkeep, if your life total is 20 or higher, [CARD_NAME] gets +1/+1.",

        "Flying, Lifelink. At the beginning of your upkeep, if you have 20+ life, [CARD_NAME] gets +1/+1.",

        "Flying, Lifelink. At your upkeep, if you have at least 20 life, [CARD_NAME] grows by +1/+1.",

        "Flying, Lifelink. At the beginning of your upkeep, if your life total is at least 20, [CARD_NAME] gets +1/+1.",

        "Flying, Lifelink. At the beginning of your upkeep, if you have twenty or more life, [CARD_NAME] gets +1/+1.",

        "Flying, Lifelink. At the beginning of your upkeep, if you have at least 20 life, [CARD_NAME] gains +1/+1.",
