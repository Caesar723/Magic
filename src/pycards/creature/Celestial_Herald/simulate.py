...
class Celestial_Herald_Simulation(Card_Simulation):
    ...
    similar_descriptions:list[str]=[
        ...
        "Flying, Lifelink. At the start of your upkeep, exile a random nonland permanent an opponent controls, then return it at the beginning of the next end step.",
        ...
        "Flying, Lifelink. At the beginning of your upkeep, temporarily exile a random nonland permanent an opponent controls until the next end step.",
        ...
        "Flying, Lifelink. At your upkeep, exile a random nonland opposing permanent and return it at the beginning of the next end step.",
        ...
        "Flying, Lifelink. At the beginning of your upkeep, exile a random nonland permanent an opponent owns. Return it at the next end step.",
