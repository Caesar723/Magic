...
from pycards.creature.Celestial_Guardian.model import Celestial_Guardian

@bind_card(Celestial_Guardian)
class Celestial_Guardian_Simulation(Card_Simulation):
