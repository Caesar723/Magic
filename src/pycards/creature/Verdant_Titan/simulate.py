...
class Verdant_Titan_Simulation(Card_Simulation):
    ...
    similar_descriptions:list[str]=[
        ...
        "Trample, Vigilance. When [CARD_NAME] enters the battlefield or attacks, you may search your library for a land, put it onto the battlefield tapped, then shuffle if you do.",
        ...
        "Trample, Vigilance. When [CARD_NAME] enters or attacks, you may find a land, put it onto the battlefield tapped, then shuffle your library if you do.",
        ...
        "Trample, Vigilance. When [CARD_NAME] enters the battlefield or attacks, you may search your library for a land card, place it onto the battlefield tapped, then shuffle if you do.",
        ...
        "Trample, Vigilance. When [CARD_NAME] enters the battlefield or attacks, you may search your library for a land, put it on the battlefield tapped, shuffle if you do.",
