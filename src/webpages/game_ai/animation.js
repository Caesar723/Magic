class Animation{//action
    ...
    // Action-bar history preview builds CardPlane / life-ring meshes. This
    // fork must match `gaming_page/animation.js` or meshes never leave the scene.
...
class Creature_Prepare_Attack extends Animation{
    ...
    set_animate(){
        if (this.player instanceof Opponent){
            this.player.table.client.tutor.analysis_situation_atteck(this.object_hold)
        }
    ...
    set_animate(){
        ...
        if (this.object_hold instanceof Creature_Hand){
            ...
            if (this.player instanceof Opponent){
                ...
                this.player.table.client.tutor.analysis_situation(false)
