...
class Creature extends Card {
    constructor(width,height,position,size,dynamic_canvas,color_fee,Life,Damage,name){
...
class Land extends Card {
    constructor(width,height,position,size,dynamic_canvas,name){
        super(width,height,position,size,dynamic_canvas,"",name)
        this.type="Land";
