...
class TestAngelic_Protector(CardTestCaseBase):
    async def test_angelic_protector_smoke(self):
        card_cls = load_card_class_from_path("pycards/creature/Angelic_Protector/model.py", "Angelic_Protector")
        env = self.make_env()
    ...
    async def test_angelic_protector_custom_scenario_template(self):
