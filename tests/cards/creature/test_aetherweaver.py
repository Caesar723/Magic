...
class TestAetherweaver(CardTestCaseBase):
    async def test_aetherweaver_smoke(self):
        card_cls = load_card_class_from_path("pycards/creature/Aetherweaver/model.py", "Aetherweaver")
        env = self.make_env()
    ...
    async def test_aetherweaver_custom_scenario_template(self):
